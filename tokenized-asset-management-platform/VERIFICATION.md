...
forge verify-contract --chain-id 97  --watch --constructor-args $(cast abi-encode "constructor(string,string,address,address)" "Asset NFT" "ANFT" "$DEPLOYER_ADDRESS" "$KYC_REGISTRY_ADDRESS") $ASSET_NFT_ADDRESS src/AssetNFT.sol:AssetNFT --etherscan-api-key $BSCSCAN_API_KEY
